...
// Connecting Lines (Optional - expensive for many particles, maybe distinct object)
// Let's add a few floating geometric shapes instead for depth
...
// scene.add(sphere); // Keeping it clean for now, just particles
...
const tick = () => {
  ...
  // Wave motion
  // Access positions to animate them individually if desired
  // For now, simple rotation is "legendary" enough combined with the CSS blur.
